...
function hexResize() {
    ...
    if ($(window).width() > 1340) {
        ...
        $('.hex1').css({ "width": innerWidth * 30 / 100, "height": innerWidth * 30 / 100 });
        $('.hex-style1').css({ "width": innerWidth * 20 / 100, "height": innerWidth * 20 / 100 });
        $('.hex-style2').css({ "width": innerWidth * 20 / 100, "height": innerWidth * 20 / 100 });
        ...
        $('.hex-style2').css({ "width": innerWidth * 30 / 100, "height": innerWidth * 30 / 100 });
    }
    //  else if ($(window).width() < 576) {
    //     $('.hex1').css({ "width": innerWidth * 70 / 100, "height": innerWidth * 70 / 100 });
    //     $('.hex-style1').css({ "width": innerWidth * 30 / 100, "height": innerWidth * 30 / 100 });
    //     $('.hex-style2').css({ "width": innerWidth * 30 / 100, "height": innerWidth * 30 / 100 });
    // }

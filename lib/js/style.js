...
$(document).ready(function() {
    ...
    //     if (innerWidth > 2500) {
    //         $('.hex1').css({
    //             'width': innerWidth * 13 / 100,
    //             'height': innerWidth * 13 / 100
    //         });
    //         $('.hex-style1').css({
    //             'width': innerWidth * 8 / 100,
    //             'height': innerWidth * 8 / 100
    //         });

    //     } else if (innerWidth > 2500) {
    //         $('.hex1').css({
    //             'width': innerWidth * 12 / 100,
    //             'height': innerWidth * 12 / 100
    //         });
    //         $('.hex-style1').css({
    //             'width': innerWidth * 4 / 100,
    //             'height': innerWidth * 4 / 100
    //         });
    //     }
    // });
